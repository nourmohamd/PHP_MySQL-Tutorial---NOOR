...
<div class="container">
    ...
    <?php
        ...
        if (isset($_GET["add_new_box_in_list"])) {
            ...
            header("Location: http://localhost/Application1/admin/create_todolist.php");
        }
        if(isset($_GET["remove_do_item"])) {
            ...
            header("refresh:2;url=http://localhost/Application1/admin/create_todolist.php");
        }
        if(isset($_GET["process_do_item_to_true"])) {
            ...
            $sql->bindParam("IU", $id_user_);
            $sql->execute();
            header("refresh:1;url=http://localhost/Application1/admin/create_todolist.php");
        }
